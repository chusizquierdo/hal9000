...
import News from './News'; // <-- Nueva importación integrada de Noticias
    ...
    <div className="max-w-7xl mx-auto px-4 py-0">
      ...
      <div className="flex flex-col gap-4 mb-8">
        <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight mt-2">
          {/* Título dinámico adaptado para incluir Noticias de Cine */}
          {userIdFilter ? 'Tu Biblioteca' : activeTab === 'feed' ? 'Feed de Reseñas' : activeTab === 'rankings' ? 'Mejores Valoradas' : activeTab === 'leaderboard' ? 'Ranking de Críticos' : activeTab === 'upcoming' ? 'Próximos Estrenos' : activeTab === 'news' ? 'Noticias de Cine' : 'Próximos Tráilers'}
        </h1>
      ...
      {activeTab === 'feed' ? (
        ...
        <News /> // <-- Componente inyectado en el enrutamiento condicional
      ) : (
        <Trailers />
      )}
    </div>
